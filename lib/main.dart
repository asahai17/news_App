...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> getNews({
    ...
    if (channel != null) {
      ...
      category = null;
      baseApi =
          'https://newsapi.org/v2/top-headlines?pageSize=10&page=$pageNum&sources=$channel&apiKey=5733eb82f6304e8f8dce26f6fd0ea8fd';
    }
    if (searchKey != null) {
      country = null;
      category = null;
      baseApi =
          'https://newsapi.org/v2/top-headlines?pageSize=10&page=$pageNum&q=$searchKey&apiKey=5733eb82f6304e8f8dce26f6fd0ea8fd';
    }
    //print(baseApi);
